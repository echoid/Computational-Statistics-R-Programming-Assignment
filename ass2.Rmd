...
legend(0,5.5,c("Image Density","Estimated"), lwd=c(2,2), col=c("black",2), y.intersp=1.5)
...
#z_max_ = new[match(z_max,c(1,2,3))]

```

```{r}
image.plot(matrix(z_max,nrow = 398,ncol = 398))
```


```{r}
image.plot(matrix(z_predict,nrow = 398,ncol = 398))
```
